...
import ls.yylx.lscodestore.basemodule.network.GlideApp
import ls.yylx.lscodestore.firstmodule.ShowImageDialogFragment
...
class ChoiceImageFragment() : DialogFragment() {
            ...
            with(ui) {
                constraintLayout {
                    ...
                    customView<AppCompatCheckBox> {
                        id = ID_CB
                        buttonTintList = ColorStateList.valueOf(resources.getColor(R.color.colorAccent))
